...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'presets': 'Presets',
      'presets_home_subtitle': 'All focus modes',
      'see_all': 'See all',
      'preset': 'Preset',
      'free': 'Free',
      'premium': 'Premium',
      ...
      'start_free_trial': 'Start Free Trial',
        'trial_caption_monthly': '3 days free, then €3.99 / month. Cancel anytime.',
        'trial_caption_yearly': '3 days free, then €29.99 / year. Cancel anytime.',
    ...
    'ru': {
      ...
      'presets': 'Пресеты',
      'presets_home_subtitle': 'Все режимы фокуса',
      'see_all': 'Все',
      'preset': 'Пресет',
      'free': 'Бесплатно',
      'premium': 'Премиум',
      ...
      'start_free_trial': 'Начать пробный период',
        'trial_caption_monthly': '3 дня бесплатно, затем €3.99 / месяц. Отмена в любой момент.',
        'trial_caption_yearly': '3 дня бесплатно, затем €29.99 / год. Отмена в любой момент.',
    ...
    'uk': {
      ...
      'presets': 'Пресети',
      'presets_home_subtitle': 'Усі режими фокусу',
      'see_all': 'Усі',
      'preset': 'Пресет',
      'free': 'Безкоштовно',
      'premium': 'Преміум',
      ...
      'start_free_trial': 'Почати безкоштовну пробу',
        'trial_caption_monthly': '3 дні безкоштовно, потім €3.99 / місяць. Скасувати будь‑коли.',
        'trial_caption_yearly': '3 дні безкоштовно, потім €29.99 / рік. Скасувати будь‑коли.',
